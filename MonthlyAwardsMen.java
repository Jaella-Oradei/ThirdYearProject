...
public class MonthlyAwardsMen implements ActionListener{
    JFrame baseFrame = new JFrame("Monthly Awards");
    ...
    public MonthlyAwardsMen(){
        ...
        addFitnessAward("Steps Streak");
        addFitnessAward("5 exercises");
        addFitnessAward("10 exercises");
        addFitnessAward("10km run");

        addhealthAward("12 cups Water");
        addhealthAward("Calorie Intake");
        addhealthAward("5-a-Day");
    ...
    public void addFitnessAward(String awardName){
        if (!fitnessAwardsLabels.containsKey(awardName)){
            ...
            newAwards.setBackground(Color.decode("#FFD700"));
