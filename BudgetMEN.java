...
public class BudgetMEN implements ActionListener{
    ...
    public BudgetMEN(){
        ...
        rPanel.setBackground(Color.decode("#7DF9FF"));
        caloriePanel.setBackground(Color.decode("#7DF9FF"));

        increaseButton.setBackground(Color.decode("#6488EA"));
        decreaseButton.setBackground(Color.decode("#6488EA"));

        returnbtn.setBackground(Color.decode("#6488EA"));
        confirmBtn.setBackground(Color.decode("#39FF14"));
